...
define('pix-live/tests/mixins/scrolling.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - mixins/scrolling.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('mixins/scrolling.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
