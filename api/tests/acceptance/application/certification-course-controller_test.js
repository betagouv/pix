...
describe('Acceptance | API | Certification Course', function() {
  ...
  describe('GET /api/admin/certifications/{id}/result', function() {

    const courseId = '1';
    const options = { method: 'GET', url: `/api/admin/certifications/${courseId}/result` };
    ...
    it('should return 404 HTTP status code if certification not found', function() {
      // when
      const promise = server.inject({ method: 'GET', url: '/api/admin/certifications/200/result' });
