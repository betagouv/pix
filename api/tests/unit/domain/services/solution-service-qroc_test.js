...
describe('Unit | Service | SolutionServiceQROC ', function () {
  ...
  describe('match, single solution, t1 and t3 deactivated', function () {

    const allCases = [
      {when:'no stress',                   output: 'ok', answer: 'Answer',      solution: 'Answer',      deactivations: {t1:true, t3:true}},
      {when:'spaces stress',               output: 'ko', answer: 'a b c d e',   solution: 'abcde',       deactivations: {t1:true, t3:true}},
      {when:'reverted spaces stress',      output: 'ko', answer: 'abcde',       solution: 'a b c d e',   deactivations: {t1:true, t3:true}},
      {when:'uppercase stress',            output: 'ko', answer: 'ANSWER',      solution: 'answer',      deactivations: {t1:true, t3:true}},
      {when:'reverted uppercase stress',   output: 'ko', answer: 'answer',      solution: 'ANSWER',      deactivations: {t1:true, t3:true}},
      {when:'accent stress',               output: 'ko', answer: 'îàé êêê',     solution: 'iae eee',     deactivations: {t1:true, t3:true}},
      {when:'reverted accent stress',      output: 'ko', answer: 'iae eee',     solution: 'îàé êêê',     deactivations: {t1:true, t3:true}},
      {when:'diacritic stress',            output: 'ko', answer: 'ççççç',       solution: 'ccccc',       deactivations: {t1:true, t3:true}},
      {when:'reverted diacritic stress',   output: 'ko', answer: 'ccccc',       solution: 'ççççç',       deactivations: {t1:true, t3:true}},
      {when:'punctuation stress',          output: 'ok', answer: '.!p-u-n-c-t', solution: 'punct',       deactivations: {t1:true, t3:true}},
      {when:'reverted punctuation stress', output: 'ok', answer: 'punct',       solution: '.!p-u-n-c-t', deactivations: {t1:true, t3:true}},
      {when:'levenshtein stress',          output: 'ko', answer: '0123456789',  solution: '123456789',   deactivations: {t1:true, t3:true}},
      {when:'reverted levenshtein stress', output: 'ko', answer: '123456789',   solution: '0123456789',  deactivations: {t1:true, t3:true}},
    ];
  ...
  describe('match, single solution, t2 and t3 deactivated', function () {

    const allCases = [
      {when:'no stress',                   output: 'ok', answer: 'Answer',      solution: 'Answer',      deactivations: {t2:true, t3:true}},
      {when:'spaces stress',               output: 'ok', answer: 'a b c d e',   solution: 'abcde',       deactivations: {t2:true, t3:true}},
      {when:'reverted spaces stress',      output: 'ok', answer: 'abcde',       solution: 'a b c d e',   deactivations: {t2:true, t3:true}},
      {when:'uppercase stress',            output: 'ok', answer: 'ANSWER',      solution: 'answer',      deactivations: {t2:true, t3:true}},
      {when:'reverted uppercase stress',   output: 'ok', answer: 'answer',      solution: 'ANSWER',      deactivations: {t2:true, t3:true}},
      {when:'accent stress',               output: 'ok', answer: 'îàé êêê',     solution: 'iae eee',     deactivations: {t2:true, t3:true}},
      {when:'reverted accent stress',      output: 'ok', answer: 'iae eee',     solution: 'îàé êêê',     deactivations: {t2:true, t3:true}},
      {when:'diacritic stress',            output: 'ok', answer: 'ççççç',       solution: 'ccccc',       deactivations: {t2:true, t3:true}},
      {when:'reverted diacritic stress',   output: 'ok', answer: 'ccccc',       solution: 'ççççç',       deactivations: {t2:true, t3:true}},
      {when:'punctuation stress',          output: 'ko', answer: '.!p-u-n-c-t', solution: 'punct',       deactivations: {t2:true, t3:true}},
      {when:'reverted punctuation stress', output: 'ko', answer: 'punct',       solution: '.!p-u-n-c-t', deactivations: {t2:true, t3:true}},
      {when:'levenshtein stress',          output: 'ko', answer: '0123456789',  solution: '123456789',   deactivations: {t2:true, t3:true}},
      {when:'reverted levenshtein stress', output: 'ko', answer: '123456789',   solution: '0123456789',  deactivations: {t2:true, t3:true}},
    ];
  ...
  describe('match, single solution, t1, t2 and t3 deactivated', function () {

    const allCases = [
      {when:'no stress',                   output: 'ok', answer: 'Answer',      solution: 'Answer',      deactivations: {t1:true, t2:true, t3:true}},
      {when:'spaces stress',               output: 'ko', answer: 'a b c d e',   solution: 'abcde',       deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted spaces stress',      output: 'ko', answer: 'abcde',       solution: 'a b c d e',   deactivations: {t1:true, t2:true, t3:true}},
      {when:'uppercase stress',            output: 'ko', answer: 'ANSWER',      solution: 'answer',      deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted uppercase stress',   output: 'ko', answer: 'answer',      solution: 'ANSWER',      deactivations: {t1:true, t2:true, t3:true}},
      {when:'accent stress',               output: 'ko', answer: 'îàé êêê',     solution: 'iae eee',     deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted accent stress',      output: 'ko', answer: 'iae eee',     solution: 'îàé êêê',     deactivations: {t1:true, t2:true, t3:true}},
      {when:'diacritic stress',            output: 'ko', answer: 'ççççç',       solution: 'ccccc',       deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted diacritic stress',   output: 'ko', answer: 'ccccc',       solution: 'ççççç',       deactivations: {t1:true, t2:true, t3:true}},
      {when:'punctuation stress',          output: 'ko', answer: '.!p-u-n-c-t', solution: 'punct',       deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted punctuation stress', output: 'ko', answer: 'punct',       solution: '.!p-u-n-c-t', deactivations: {t1:true, t2:true, t3:true}},
      {when:'levenshtein stress',          output: 'ko', answer: '0123456789',  solution: '123456789',   deactivations: {t1:true, t2:true, t3:true}},
      {when:'reverted levenshtein stress', output: 'ko', answer: '123456789',   solution: '0123456789',  deactivations: {t1:true, t2:true, t3:true}},
    ];
