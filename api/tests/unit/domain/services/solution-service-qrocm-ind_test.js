...
describe('Unit | Service | SolutionServiceQROCM-ind ', function () {
  ...
  //Pour notre cas : enabledTreatments = ['t1', 't2', 't3']
  ...
  //Pour notre cas : enabledTreatments = ['t2', 't3']
  ...
  //Pour notre cas : enabledTreatments = ['t1', 't3']
