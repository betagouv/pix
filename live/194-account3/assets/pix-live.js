...
define('pix-live/adapters/application', ['exports', 'ember-data', 'pix-live/config/environment', 'ember-simple-auth/mixins/data-adapter-mixin'], function (exports, _emberData, _pixLiveConfigEnvironment, _emberSimpleAuthMixinsDataAdapterMixin) {
...
define('pix-live/authenticators/jwt', ['exports', 'ember', 'ember-simple-auth/authenticators/base', 'pix-live/config/environment'], function (exports, _ember, _emberSimpleAuthAuthenticatorsBase, _pixLiveConfigEnvironment) {
  ...
  exports['default'] = _emberSimpleAuthAuthenticatorsBase['default'].extend({
    ...
    tokenEndpoint: _pixLiveConfigEnvironment['default'].APP.API_HOST + '/api/tokens/user_token',
    ...
    authenticate: function authenticate(creds) {
      var firstName = creds.firstName;
      var lastName = creds.lastName;
      var email = creds.email;
      var password = creds.password;
      var passwordConfirm = creds.passwordConfirm;
      var hasAcceptedCGU = creds.hasAcceptedCGU;
...
define('pix-live/authorizers/custom', ['exports', 'ember-simple-auth/authorizers/base', 'ember'], function (exports, _emberSimpleAuthAuthorizersBase, _ember) {
...
define('pix-live/components/login-form', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({});
});
...
define('pix-live/components/registration-form', ['exports', 'ember', 'lodash/lodash'], function (exports, _ember, _lodashLodash) {
    ...
    actions: {
      ...
      identify: function identify() {
        ...
        this.get('session').authenticate(authenticator, credentials).then(function () {
          removeAllNotices();
          callActionOnUserIdentified(_this);
          ...
          $(function () {
            ...
            var errorsAsString = '';
            _lodashLodash['default'].each(arrayOfErrors, function (currentError) {
            ...
            new PNotify({
              ...
              animate_speed: "slow",
              animation: "fade",
              after_init: function after_init(notice) {
                setTimeout(function () {
...
define('pix-live/mirage/config', ['exports', 'pix-live/mirage/routes/get-challenge', 'pix-live/mirage/routes/get-challenges', 'pix-live/mirage/routes/get-course', 'pix-live/mirage/routes/get-courses', 'pix-live/mirage/routes/get-answer', 'pix-live/mirage/routes/post-answers', 'pix-live/mirage/routes/post-user-token', 'pix-live/mirage/routes/get-assessment', 'pix-live/mirage/routes/post-assessments'], function (exports, _pixLiveMirageRoutesGetChallenge, _pixLiveMirageRoutesGetChallenges, _pixLiveMirageRoutesGetCourse, _pixLiveMirageRoutesGetCourses, _pixLiveMirageRoutesGetAnswer, _pixLiveMirageRoutesPostAnswers, _pixLiveMirageRoutesPostUserToken, _pixLiveMirageRoutesGetAssessment, _pixLiveMirageRoutesPostAssessments) {
  exports['default'] = function () {
    ...
    this.post('/tokens/user_token', _pixLiveMirageRoutesPostUserToken['default']);
  };
});
...
define('pix-live/mirage/routes/get-answer', ['exports', 'pix-live/mirage/data/answers/qcu-answer', 'pix-live/mirage/data/answers/qcu-answer-with-image', 'pix-live/mirage/data/answers/qcm-answer', 'pix-live/mirage/data/answers/qrocm-answer', 'pix-live/mirage/data/answers/qcm-answer-ko', 'pix-live/mirage/data/answers/qcm-answer-ok', 'lodash/lodash'], function (exports, _pixLiveMirageDataAnswersQcuAnswer, _pixLiveMirageDataAnswersQcuAnswerWithImage, _pixLiveMirageDataAnswersQcmAnswer, _pixLiveMirageDataAnswersQrocmAnswer, _pixLiveMirageDataAnswersQcmAnswerKo, _pixLiveMirageDataAnswersQcmAnswerOk, _lodashLodash) {
  exports['default'] = function (schema, request) {

    var allAnswers = [_pixLiveMirageDataAnswersQcuAnswer['default'], _pixLiveMirageDataAnswersQcuAnswerWithImage['default'], _pixLiveMirageDataAnswersQcmAnswer['default'], _pixLiveMirageDataAnswersQrocmAnswer['default'], _pixLiveMirageDataAnswersQcmAnswerKo['default'], _pixLiveMirageDataAnswersQcmAnswerOk['default']];
...
define('pix-live/mirage/routes/post-user-token', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  ...
  exports['default'] = function (schema, request) {
    ...
    if (hasInvalidEmail(params)) {
      return new _emberCliMirage['default'].Response(422, { some: 'header' }, { data: ['l\'email n\'est pas valide'] });
    } else {
...
define('pix-live/routes/application', ['exports', 'ember', 'ember-simple-auth/mixins/application-route-mixin'], function (exports, _ember, _emberSimpleAuthMixinsApplicationRouteMixin) {
  ...
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model(params) {
      ...
      return store.findRecord('course', params.course_id).then(function (course) {
        ...
        var userName = _this.get('sessionAccount.account.firstName') + ' ' + _this.get('sessionAccount.account.firstName');
        var userEmail = _this.get('sessionAccount.account.email');
...
define('pix-live/routes/index', ['exports', 'ember', 'ember-simple-auth/mixins/unauthenticated-route-mixin'], function (exports, _ember, _emberSimpleAuthMixinsUnauthenticatedRouteMixin) {
...
define('pix-live/services/session-account', ['exports', 'ember'], function (exports, _ember) {
  var service = _ember['default'].inject.service;
    ...
    loadCurrentUser: function loadCurrentUser() {
      ...
      return new RSVP.Promise(function (resolve, reject) {
        ...
        if (!_ember['default'].isEmpty(token)) {
          return _this.get('store').findRecord('user', 'current-user').then(function (user) {
...
define('pix-live/services/session', ['exports', 'ember-simple-auth/services/session'], function (exports, _emberSimpleAuthServicesSession) {
...
define("pix-live/templates/components/app-header", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("div");
          dom.setAttribute(el3, "class", "profile nav navbar-nav navbar-right");
          var el4 = dom.createTextNode("\n              ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("p");
          dom.setAttribute(el4, "class", "navbar-text");
          var el5 = dom.createTextNode("\n                  ");
          dom.appendChild(el4, el5);
          var el5 = dom.createElement("div");
          dom.setAttribute(el5, "style", "display:inline-block;width:auto");
          dom.setAttribute(el5, "class", "header-user");
          var el6 = dom.createTextNode("\n                    Bonjour ");
          dom.appendChild(el5, el6);
          var el6 = dom.createComment("");
          dom.appendChild(el5, el6);
          ...
          dom.setAttribute(el6, "width", "24");
          dom.setAttribute(el6, "height", "24");
          dom.setAttribute(el6, "viewBox", "0 0 24 24");
          var el7 = dom.createElement("path");
          dom.setAttribute(el7, "d", "M14 12h-4v-12h4v12zm4.213-10.246l-1.213 1.599c2.984 1.732 5 4.955 5 8.647 0 5.514-4.486 10-10 10s-10-4.486-10-10c0-3.692 2.016-6.915 5-8.647l-1.213-1.599c-3.465 2.103-5.787 5.897-5.787 10.246 0 6.627 5.373 12 12 12s12-5.373 12-12c0-4.349-2.322-8.143-5.787-10.246z");
          dom.appendChild(el6, el7);
          dom.appendChild(el5, el6);
          var el6 = dom.createTextNode("\n                  ");
          dom.appendChild(el5, el6);
        ...
        statements: [["attribute", "src", ["concat", [["get", "rootURL", ["loc", [null, [13, 28], [13, 35]]], 0, 0, 0, 0], "images/pix-logo.png"], 0, 0, 0, 0, 0], 0, 0, 0, 0], ["content", "sessionAccount.account.firstName", ["loc", [null, [19, 28], [19, 64]]], 0, 0, 0, 0], ["element", "action", ["invalidateSession"], [], ["loc", [null, [21, 77], [21, 107]]], 0, 0]],
        locals: [],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [1, 6], [1, 29]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [1, 0], [28, 7]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("pix-live/templates/components/login-form", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "revision": "Ember@2.8.3",
        ...
        "moduleName": "pix-live/templates/components/login-form.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
...
define("pix-live/templates/components/registration-form", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "revision": "Ember@2.8.3",
        ...
        "moduleName": "pix-live/templates/components/registration-form.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("label");
        dom.setAttribute(el3, "for", "inputFirstName");
        var el4 = dom.createTextNode("Prénom");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        ...
        dom.setAttribute(el3, "id", "inputFirstName");
        dom.setAttribute(el3, "placeholder", "Votre prénom");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("label");
        dom.setAttribute(el3, "for", "inputLastName");
        var el4 = dom.createTextNode("Nom");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        ...
        dom.setAttribute(el3, "type", "text");
        dom.setAttribute(el3, "class", "form-control");
        dom.setAttribute(el3, "id", "inputLastName");
        dom.setAttribute(el3, "placeholder", "Votre nom");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        ...
        var el4 = dom.createTextNode("Mot de passe ");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el3, "placeholder", "Mot de passe");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("label");
        dom.setAttribute(el3, "for", "inputPasswordConfirm");
        var el4 = dom.createTextNode("Confirmation du mot de passe ");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el3, "type", "password");
        dom.setAttribute(el3, "class", "form-control");
        dom.setAttribute(el3, "id", "inputPasswordConfirm");
        dom.setAttribute(el3, "placeholder", "Mot de passe");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el4, "for", "inputHasAcceptedCGU");
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("input");
        dom.setAttribute(el5, "type", "checkbox");
        dom.setAttribute(el5, "id", "inputHasAcceptedCGU");
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n        J'accepte les CGU\n      ");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el3, "class", "button button-primary");
        dom.setAttribute(el3, "type", "submit");
        dom.setAttribute(el3, "id", "buttonRegister");
        var el4 = dom.createTextNode("Enregistrez-vous");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
      ...
      statements: [["element", "action", ["identify"], ["on", "submit"], ["loc", [null, [1, 31], [1, 64]]], 0, 0]],
      locals: [],
      templates: []
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("div");
        dom.setAttribute(el5, "id", "accordion");
        dom.setAttribute(el5, "class", "panel-group");
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        ...
        dom.setAttribute(el9, "data-parent", "#accordion");
        dom.setAttribute(el9, "href", "#collapseOne");
        dom.setAttribute(el9, "data-toggle", "collapse");
        var el10 = dom.createTextNode("Enregistrez-vous");
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7, "id", "collapseOne");
        dom.setAttribute(el7, "class", "panel-collapse collapse");
        var el8 = dom.createTextNode("\n                            ");
        dom.appendChild(el7, el8);
        ...
        dom.setAttribute(el6, "data-target", "#collapseTwo");
        var el7 = dom.createTextNode("\n                        ");
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7, "class", "panel-heading");
        ...
        var el9 = dom.createElement("a");
        dom.setAttribute(el9, "data-parent", "#accordion");
        dom.setAttribute(el9, "href", "#collapseTwo");
        var el10 = dom.createTextNode("Connectez-vous");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
        var el9 = dom.createTextNode("\n                            ");
        dom.appendChild(el8, el9);
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7, "id", "collapseTwo");
        dom.setAttribute(el7, "class", "panel-collapse collapse");
        var el8 = dom.createTextNode("\n                            ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("div");
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        var element0 = dom.childAt(fragment, [0, 3, 3, 1, 1]);
        var morphs = new Array(2);
        morphs[0] = dom.createMorphAt(dom.childAt(element0, [1, 3, 1]), 1, 1);
        morphs[1] = dom.createMorphAt(dom.childAt(element0, [3, 3, 1]), 1, 1);
        return morphs;
      },
      statements: [["inline", "registration-form", [], ["onUserIdentified", "navigateToHome"], ["loc", [null, [28, 32], [28, 87]]], 0, 0], ["inline", "login-form", [], ["onUserIdentified", "navigateToHome"], ["loc", [null, [40, 32], [40, 80]]], 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
define('pix-live/tests/mirage/mirage/routes/post-user-token.lint-test', ['exports'], function (exports) {
  describe('ESLint - mirage/routes/post-user-token.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('mirage/routes/post-user-token.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"/","name":"pix-live","version":"1.0.0+826e5c79"});
}
