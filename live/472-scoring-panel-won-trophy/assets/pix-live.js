...
define('pix-live/components/scoring-panel', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    hasATrophy: _ember['default'].computed('assessment', function () {
...
define("pix-live/templates/components/scoring-panel", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Km6JSNa/", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel\"],[\"flush-element\"],[\"text\",\"\\n\\n\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_trophy\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_trophy-svg\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"rootURL\"]],\"/images/coupe.svg\"]]],[\"static-attr\",\"alt\",\"Coupe obtenue\"],[\"static-attr\",\"class\",\"\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_trophy-level\"],[\"flush-element\"],[\"text\",\"NIVEAU \"],[\"append\",[\"unknown\",[\"assessment\",\"estimatedLevel\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_trophy-bêta\"],[\"flush-element\"],[\"text\",\"BÊTA\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats-course-name\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"assessment\",\"course\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats-line\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats-felicitations\"],[\"flush-element\"],[\"text\",\"Félicitations\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats-scoring\"],[\"flush-element\"],[\"text\",\"Vous avez obtenu le niveau \"],[\"append\",[\"unknown\",[\"assessment\",\"estimatedLevel\"]],false],[\"text\",\" pour cette\\n        compétence et avez gagné \"],[\"append\",[\"unknown\",[\"assessment\",\"pixScore\"]],false],[\"text\",\" pix\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"scoring-panel_congrats-beta\"],[\"flush-element\"],[\"text\",\"*En version bêta, les pix et niveaux délivrés sont provisoires\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/components/scoring-panel.hbs" } });
});
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","isChallengeTimerEnable":true,"MESSAGE_DISPLAY_DURATION":1500,"isMobileSimulationEnabled":false,"isTimerCountdownEnabled":true,"name":"pix-live","version":"1.8.1+42945987"});
}
