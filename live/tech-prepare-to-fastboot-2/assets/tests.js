...
define('pix-live/tests/acceptance/a4-demarrer-un-test-test', ['mocha', 'chai', 'pix-live/tests/helpers/application', 'pix-live/utils/lodash-custom'], function (_mocha, _chai, _application, _lodashCustom) {
  ...
  var MODAL_SELECTOR = '.mobile-warning-modal__container.in';
  ...
  (0, _mocha.describe)('Acceptance | a4 - Démarrer un test |', function () {
    ...
    (0, _mocha.it)('a4.5 Quand je démarre un test sur mobile, une modale m\'avertie que l\'expérience ne sera pas optimale, mais je peux quand même continuer', function (done) {
      ...
      andThen(function () {
        ...
        var $continueButton = findWithAssert('.mobile-warning-modal__confirm-button');
...
define('pix-live/tests/integration/components/modal-mobile-test', ['chai', 'mocha', 'ember-mocha'], function (_chai, _mocha, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration | Component | modal mobile', function () {
    ...
    (0, _mocha.it)('should display a title with a "warning" icon', function () {
      ...
      // then
      var $titleWarningIcon = this.$('.mobile-warning-modal__icon');
