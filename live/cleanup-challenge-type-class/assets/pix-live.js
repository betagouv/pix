...
define('pix-live/routes/assessments/get-challenge', ['exports', 'ember', 'rsvp', 'pix-live/utils/lodash-custom'], function (exports, _ember, _rsvp, _pixLiveUtilsLodashCustom) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    _componentClassForChallenge: function _componentClassForChallenge(challenge) {
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","isChallengeTimerEnable":true,"MESSAGE_DISPLAY_DURATION":1500,"isMobileSimulationEnabled":false,"isTimerCountdownEnabled":true,"name":"pix-live","version":"1.7.0+a25e1171"});
}
