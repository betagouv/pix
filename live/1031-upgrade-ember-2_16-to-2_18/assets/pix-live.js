...
define('pix-live/models/course', ['exports', 'ember-data'], function (exports, _emberData) {
  ...
  exports.default = Model.extend({
    ...
    type: Ember.computed('isAdaptive', function () {
