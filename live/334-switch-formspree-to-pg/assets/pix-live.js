...
define('pix-live/components/follower-form', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    submitButton: _ember['default'].computed('isSubmited', function () {
    ...
    _checkEmail: function _checkEmail(context, email) {
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"/","name":"pix-live","version":"4.0.0+38b6606f"});
}
