...
define('pix-live/components/follower-form', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    infoMessage: _ember['default'].computed('hasError', 'isSubmited', function () {
    ...
    _hasValidEmail: function _hasValidEmail(context) {
      return context.get('emailValidator').emailIsValid(context.get('email').trim());
    },

    _saveFollower: function _saveFollower(email, context) {
      $.ajax({
...
define('pix-live/routes/assessments/get-challenge', ['exports', 'ember', 'ember-data', 'pix-live/utils/get-challenge-type', 'rsvp'], function (exports, _ember, _emberData, _pixLiveUtilsGetChallengeType, _rsvp) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model(params) {
      ...
      return _rsvp['default'].hash(promises, 'assessment_challenge_answers_timer').then(function (results) {
        return results;
      });
    },
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"/","name":"pix-live","version":"4.0.0+e21e8c6d"});
}
