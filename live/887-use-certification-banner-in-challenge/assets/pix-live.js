  ...
  exports.default = _baseRoute.default.extend({
    ...
    afterModel: function afterModel(model) {
      ...
      return RSVP.hash({
        ...
        if (model.assessment.get('isCertification')) {
          return _this2.get('store').findRecord('user', _this2.get('session.data.authenticated.userId'));
        }
    ...
    _navigateToNextView: function _navigateToNextView(challenge, assessment) {
      ...
      return this.get('store').queryRecord('challenge', { assessmentId: assessment.get('id'), challengeId: challenge.get('id') }).then(function (nextChallenge) {
        return _this3.transitionTo('assessments.challenge', { assessment: assessment, challenge: nextChallenge });
      }).catch(function () {
        var endTemplate = assessment.get('type') === 'CERTIFICATION' ? 'certifications.results' : 'assessments.results';
        _this3.transitionTo(endTemplate, assessment.get('id'));
      });
    },
    ...
    actions: {
      saveAnswerAndNavigate: function saveAnswerAndNavigate(challenge, assessment, answerValue, answerTimeout, answerElapsedTime) {
        ...
        return answer.save().then(function () {
          return _this4._navigateToNextView(challenge, assessment);
        });
      }
    }
...
define("pix-live/templates/certifications/results", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "25aQuV8E", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"certification-results-page\",null,[[\"user\"],[[20,[\"model\"]]]]],false]],\"hasEval\":false}", "meta": { "moduleName": "pix-live/templates/certifications/results.hbs" } });
});
