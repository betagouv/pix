  ...
  exports.default = Ember.Component.extend({
    ...
    init: function init() {
      ...
      if (this.get('challenge.instruction')) {
        var instructionWithReplacements = this.get('challenge.instruction').replace('${EMAIL}', this._formattedEmailForInstruction());
