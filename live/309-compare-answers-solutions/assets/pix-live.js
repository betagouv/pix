...
define('pix-live/routes/assessments/get-results', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    actions: {
      ...
      openComparison: function openComparison(assessment_id, answer_id) {
...
define("pix-live/templates/assessments/get-comparison", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "aJo4SsFT", "block": "{\"statements\":[[\"append\",[\"helper\",[\"comparison-window\"],null,[[\"answer\",\"challenge\",\"solution\"],[[\"get\",[\"model\",\"answer\"]],[\"get\",[\"model\",\"challenge\"]],[\"get\",[\"model\",\"solution\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/assessments/get-comparison.hbs" } });
});
...
define("pix-live/templates/components/comparison-window", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "XQJ5qKRt", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"routable-modal--dialog\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"routable-modal--content\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"routable-modal--header\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"append\",[\"helper\",[\"routable-modal-close-button\"],null,[[\"class\"],[\"routable-modal--close\"]]],false],[\"text\",\"\\n            \"],[\"open-element\",\"h4\",[]],[\"static-attr\",\"class\",\"routable-modal--title\"],[\"flush-element\"],[\"text\",\"Modal title\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"routable-modal--body\"],[\"flush-element\"],[\"text\",\"\\n            Content\\n            \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"answerid \"],[\"append\",[\"unknown\",[\"answer\",\"id\"]],false],[\"close-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"challengeid \"],[\"append\",[\"unknown\",[\"challenge\",\"id\"]],false],[\"close-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"solutionid \"],[\"append\",[\"unknown\",[\"solution\",\"id\"]],false],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/components/comparison-window.hbs" } });
});
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"/","name":"pix-live","version":"4.0.0+09a73abc"});
}
