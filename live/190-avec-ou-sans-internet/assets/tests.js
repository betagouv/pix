...
define('pix-live/tests/components/challenge-tools-authorized.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/challenge-tools-authorized.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('components/challenge-tools-authorized.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/integration/components/challenge-tools-authorized-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-tools-authorized', 'Integration: ChallengeToolsAuthorizedComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-tools-authorized', ['loc', [null, [1, 0], [1, 30]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-tools-authorized-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-tools-authorized-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-tools-authorized-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
