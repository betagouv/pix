...
define('pix-live/tests/acceptance/196-validation-automatique-des-qcm-test', ['exports', 'mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _mocha, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
  ...
  (0, _mocha.describe)("Acceptance | 196 - Validation automatique d'un QCM, visualisation du résultat ", function () {
    ...
    (0, _mocha.it)("197.1. Pour un QCM avec toutes les réponses attendues, le tableau récapitulatif donne une indication que la réponse est correcte", function () {
      (0, _chai.expect)($summary.text()).to.contains('réponse correcte');
    });

    (0, _mocha.it)("195.2. Pour un QCM avec une mauvaise réponse, le tableau récapitulatif donne une indication que la réponse est incorrecte", function () {
      (0, _chai.expect)($summary.text()).to.contains('réponse incorrecte');
    });
  });
});
