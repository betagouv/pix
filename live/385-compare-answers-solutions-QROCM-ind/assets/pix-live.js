...
define('pix-live/components/qrocm-ind-solution-panel', ['exports', 'ember'], function (exports, _ember) {
  ...
  var QrocmIndSolutionPanel = _ember['default'].Component.extend({
    ...
    labelsAsArray: _ember['default'].computed('challenge', function () {
      var labels = this.get('challenge.proposals');
      var labelsInArray = labels.split(/\\n\\n/); //{num1}\n\n ou {num3}\n\n (convention d'ecriture dans AirTable)
      labelsInArray.forEach(function (label) {
        label.replace(/\$\{.+}/, '');
      });
...
define("pix-live/templates/components/qrocm-ind-solution-panel", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "4z4oNfbO", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"qrocm-solution-panel rounded-panel\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"rounded-panel__row \"],[\"flush-element\"],[\"text\",\"\\n\\n    \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"challenge : \"],[\"append\",[\"unknown\",[\"challenge\",\"proposals\"]],false],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"labelsAsArray\"]]],null,0],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"answer : \"],[\"append\",[\"unknown\",[\"answer\",\"value\"]],false],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"solution : \"],[\"append\",[\"unknown\",[\"solution\",\"value\"]],false],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"get\",[\"label\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"label\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/components/qrocm-ind-solution-panel.hbs" } });
});
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","name":"pix-live","version":"1.5.0+fd0c0487"});
}
