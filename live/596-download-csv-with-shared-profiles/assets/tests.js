...
define('pix-live/tests/unit/routes/board-test', ['chai', 'mocha', 'ember-mocha', 'sinon'], function (_chai, _mocha, _emberMocha, _sinon) {
  ...
  (0, _mocha.describe)('Unit | Route | board', function () {
    ...
    (0, _mocha.it)('should call _organizationSnaphostsExportUrl with organizationId', function () {
      // given
      var firstOrganization = Ember.Object.create({ id: 1, snapshots: [] });
      var reloadStub = _sinon.default.stub();
      ...
      var user = Ember.Object.create({ id: 1, organizations: [firstOrganization, { id: 2 }] });
      findRecord.resolves(user);
      _sinon.default.stub(route, '_getOrganizationSnapshotsExportUrl');
      ...
      // then
      return promise.then(function (_) {
        _sinon.default.assert.calledOnce(route._getOrganizationSnapshotsExportUrl);
        _sinon.default.assert.calledWith(route._getOrganizationSnapshotsExportUrl, 2);
      });
    });
    ...
    (0, _mocha.describe)('#_organizationSnaphostsExportUrl', function () {
      (0, _mocha.it)('should return export URL with organization ID passed in parameters', function () {
        // when
        var url = route._getOrganizationSnapshotsExportUrl(2);

        // then
        (0, _chai.expect)(url).to.be.equal('http://localhost:3000/api/organizations/2/snapshots/export');
      });
    });
  });
});
