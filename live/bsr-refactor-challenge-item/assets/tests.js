...
define('pix-live/tests/acceptance/05-epreuve-qcu-test', ['exports', 'mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _mocha, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
  ...
  (0, _mocha.describe)("Acceptance | 05 - Afficher un QCU | ", function () {
...
define('pix-live/tests/acceptance/14-epreuve-qrocm-test', ['exports', 'mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _mocha, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
  ...
  (0, _mocha.describe)("Acceptance | 14 - Afficher un QROCM | ", function () {
...
define('pix-live/tests/integration/components/challenge-actionbar-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-actionbar', 'Integration: ChallengeActionbarComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-actionbar', ['loc', [null, [1, 0], [1, 23]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-actionbar-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-actionbar-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-actionbar-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/integration/components/challenge-item-generic-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-item-generic', 'Integration: ChallengeItemGenericComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-item-generic', ['loc', [null, [1, 0], [1, 26]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-item-generic-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-item-generic-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-item-generic-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/integration/components/challenge-item-qcm-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-item-qcm', 'Integration: ChallengeItemQcmComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-item-qcm', ['loc', [null, [1, 0], [1, 22]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-item-qcm-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-item-qcm-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-item-qcm-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/integration/components/challenge-item-qcu-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-item-qcu', 'Integration: ChallengeItemQcuComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-item-qcu', ['loc', [null, [1, 0], [1, 22]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-item-qcu-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-item-qcu-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-item-qcu-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/integration/components/challenge-item-qroc-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-item-qroc', 'Integration: ChallengeItemQrocComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-item-qroc', ['loc', [null, [1, 0], [1, 23]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-item-qroc-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-item-qroc-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-item-qroc-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/integration/components/challenge-item-qrocm-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('challenge-item-qrocm', 'Integration: ChallengeItemQrocmComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'challenge-item-qrocm', ['loc', [null, [1, 0], [1, 24]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/challenge-item-qrocm-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/challenge-item-qrocm-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/challenge-item-qrocm-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
