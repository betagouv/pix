...
define('pix-live/tests/unit/components/qrocm-ind-solution-panel-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
  ...
  _mocha.describe.only('Unit | Component | qrocm-solution-panel', function () {
    ...
    (0, _mocha.describe)('#labelsInArray', function () {

      (0, _mocha.it)('should return the labels of input in an array', function () {
        //given
        var challenge = {
          proposals: 'Clé USB : ${num1}\n\nCarte mémoire (SD) : ${num2}\n\nDisque dur externe : ${num3}\n\nCD-R / DVD-R : ${num4}'
        };
        var expectedResult = ['Clé USB : ', 'Carte mémoire (SD) : ', 'Disque dur externe : ', 'CD-R / DVD-R : '];
        var component = this.subject();
        component.set('challenge', challenge);
        //when
        var labelsAsArray = component.get('labelsInArray');
        //then
        (0, _chai.expect)(labelsAsArray).to.be.deep.equal(expectedResult);
      });

      (0, _mocha.it)('should return the labels of input in an array even if there is line jump at the end', function () {
        //given
        var challenge = {
          proposals: 'Clé USB : ${num1}\n\nCarte mémoire (SD) : ${num2}\n\n'
        };
        var expectedResult = ['Clé USB : ', 'Carte mémoire (SD) : '];
        var component = this.subject();
        component.set('challenge', challenge);
        //when
        var labelsAsArray = component.get('labelsInArray');
      ...
      (0, _mocha.it)('should return an array with empty label, if there is no proposal in challenge object', function () {
        //given
        var challenge = {
          proposals: ''
        };
    ...
    (0, _mocha.describe)('#dataToDisplay', function () {
      ...
      (0, _mocha.it)('should return an array with data to display (case when the answers are right)', function () {
        ...
        var result = [{ 'label': 'content', 'answer': ':)', 'solution': [':-)', ':)', ':-D', ':D', ':))'], 'rightAnswer': true }, { 'label': 'triste', 'answer': ':(', 'solution': [':-(', ':(', ':(('], 'rightAnswer': true }];
      ...
      (0, _mocha.it)('should return an array with data to display (case when there is wrong answers)', function () {
        ...
        var result = [{ 'label': 'Clé USB', 'answer': '1', 'solution': [2], 'rightAnswer': false }, { 'label': 'Carte mémoire (SD)', 'answer': '2', 'solution': [1], 'rightAnswer': false }];
