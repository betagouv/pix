...
define('pix-live/components/qrocm-ind-solution-panel', ['exports', 'ember', 'lodash'], function (exports, _ember, _lodash) {
  ...
  var QrocmIndSolutionPanel = _ember['default'].Component.extend({
    ...
    labelsInArray: _ember['default'].computed('challenge', function () {
      var labels = this.get('challenge.proposals');
      var labelsInArray = labels.replace(/\$\{.+}/g, '').split(/\n\n/); //{num1}\n\n ou {num3}\n\n (convention d'ecriture dans AirTable)
      labelsInArray.forEach(function (label, index) {
        if (label === '') {
    ...
    dataToDisplay: _ember['default'].computed('answer', 'solution', 'challenge', function () {
      var yamlAnswer = this.get('answer.value');
      var yamlSolution = this.get('solution.value');
      var yamlChallengeLabels = this.get('challenge.proposals'); //.replace(/\$\{/g, '').replace(/}/g, '');
      yamlChallengeLabels = yamlChallengeLabels.replace(/\$\{/g, '').replace(/}/g, '');

      var _answer = jsyaml.safeLoad(yamlAnswer);
      var _solution = jsyaml.safeLoad(yamlSolution);
      var challengeLabelsLoadInBadOrder = jsyaml.safeLoad(yamlChallengeLabels);
      var challengeLabels = _lodash['default'].invert(challengeLabelsLoadInBadOrder);

      var proposalsInput = _lodash['default'].keys(challengeLabels);
      var dataToDisplay = [];

      proposalsInput.forEach(function (keyWord) {
        var answerToDisplay = _answer[keyWord].toString();
        var solutionToDisplay = _solution[keyWord];
        var labelToDisplay = challengeLabels[keyWord];
        var rightAnswer = answerToDisplay === _solution[keyWord] || _lodash['default'].contains(_solution[keyWord], _answer[keyWord]);
...
define("pix-live/templates/components/qrocm-ind-solution-panel", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "TxEibgXF", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"qrocm-solution-panel rounded-panel\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"rounded-panel__row \"],[\"flush-element\"],[\"text\",\"\\n\\n    \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"dataToDisplay\"]]],null,1],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"svg\",[]],[\"static-attr\",\"style\",\"width:18px;height:18px\"],[\"static-attr\",\"viewBox\",\"0 0 24 24\"],[\"flush-element\"],[\"text\",\"\\n            \"],[\"open-element\",\"path\",[]],[\"static-attr\",\"fill\",\"#12caa1\"],[\"static-attr\",\"d\",\"M5,21A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19C21,20.11 20.1,21 19,21H5M6,13H14.5L11,16.5L12.42,17.92L18.34,12L12.42,6.08L11,7.5L14.5,11H6V13Z\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n          \"],[\"close-element\"],[\"text\",\"\\n          \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n            \"],[\"append\",[\"unknown\",[\"input\",\"solution\"]],false],[\"text\",\"\\n          \"],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n          \"],[\"append\",[\"unknown\",[\"input\",\"label\"]],false],[\"text\",\" :\\n          \"],[\"open-element\",\"input\",[]],[\"static-attr\",\"class\",\"\"],[\"dynamic-attr\",\"value\",[\"concat\",[[\"unknown\",[\"input\",\"answer\"]]]]],[\"static-attr\",\"disabled\",\"\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"unless\"],[[\"get\",[\"input\",\"rightAnswer\"]]],null,0]],\"locals\":[\"input\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/components/qrocm-ind-solution-panel.hbs" } });
});
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","name":"pix-live","version":"1.5.0+b4db3915"});
}
