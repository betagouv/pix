...
define('pix-live/routes/referential', ['exports', 'ember'], function (exports, _ember) {
...
define("pix-live/templates/referential", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "r7JB/ltc", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"referential-page\"],[\"flush-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"navbar-header\"],null,[[\"class\"],[\"navbar-header--white\"]]],false],[\"text\",\"\\n\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"referential-page__panel referential-page__header\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"h1\",[]],[\"static-attr\",\"class\",\"referential-page__header-text\"],[\"flush-element\"],[\"text\",\"Retrouvez les 5 domaines de compétences que Pix souhaite évaluer, en\\n      accord avec le référentiel européen DIGCOMP.\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"block\",[\"cp-panels\"],null,[[\"class\"],[\"referential-page__domains\"]],5],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"app-footer\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"              \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"domain-topic\"],[\"flush-element\"],[\"text\",\"\\n                \"],[\"open-element\",\"h3\",[]],[\"static-attr\",\"class\",\"domain-topic__title\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"topic\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n                \"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"domain-topic__description\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"topic\",\"description\"]],false],[\"close-element\"],[\"text\",\"\\n                \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"domain-topic__themes\"],[\"flush-element\"],[\"text\",\"\\n                  \"],[\"open-element\",\"h4\",[]],[\"static-attr\",\"class\",\"domain-topic__themes-title\"],[\"flush-element\"],[\"text\",\"Thématiques associées\"],[\"close-element\"],[\"text\",\"\\n                  \"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"domain-topic__themes-content\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"topic\",\"themes\"]],false],[\"close-element\"],[\"text\",\"\\n                \"],[\"close-element\"],[\"text\",\"\\n              \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"topic\"]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"referential-domain__topics\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"domain\",\"topics\"]]],null,0],[\"text\",\"          \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"          \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"referential-domain__title\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"domain\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"panel\",\"toggle\"],null,[[\"class\"],[\"referential-domain__header\"]],2],[\"block\",[\"panel\",\"body\"],null,null,1]],\"locals\":[\"panel\"]},{\"statements\":[[\"block\",[\"panels\",\"panel\"],null,[[\"class\"],[\"rounded-panel referential-domain\"]],3]],\"locals\":[\"domain\"]},{\"statements\":[[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,4]],\"locals\":[\"panels\"]}],\"hasPartials\":false}", "meta": { "moduleName": "pix-live/templates/referential.hbs" } });
});
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","name":"pix-live","version":"1.5.1+5dda00a2"});
}
