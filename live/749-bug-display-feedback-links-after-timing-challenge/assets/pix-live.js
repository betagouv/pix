  ...
  var ChallengeItemGeneric = Ember.Component.extend({
    ...
    didUpdateAttrs: function didUpdateAttrs() {
      ...
      if (!this.get('_isUserAwareThatChallengeIsTimed')) {
        ...
        this.set('hasChallengeTimer', _lodashCustom.default.isInteger(this.get('challenge.timer')));
      }
    },
    didRender: function didRender() {
      this._super.apply(this, arguments);
      var _canDisplayFeedbackPanel = this.get('challenge.timer') ? !!this.get('_isUserAwareThatChallengeIsTimed') : true;
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","isChallengeTimerEnable":true,"MESSAGE_DISPLAY_DURATION":1500,"isMobileSimulationEnabled":false,"isTimerCountdownEnabled":true,"isMessageStatusTogglingEnabled":true,"LOAD_EXTERNAL_SCRIPT":true,"GOOGLE_RECAPTCHA_KEY":"6LdPdiIUAAAAADhuSc8524XPDWVynfmcmHjaoSRO","FEEDBACK_PANEL_SCROLL_DURATION":800,"name":"pix-live","version":"1.21.0+cdd09ed3"});
}
