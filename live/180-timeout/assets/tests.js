...
define('pix-live/tests/acceptance/a1-page-accueuil-test', ['exports', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
...
define('pix-live/tests/acceptance/a1-page-accueuil-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - acceptance/a1-page-accueuil-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('pix-live/tests/acceptance/a2-afficher-logo-pix-test', ['exports', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
...
define('pix-live/tests/acceptance/a3-voir-liste-tests-test', ['exports', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
...
define('pix-live/tests/acceptance/a4-demarrer-un-test-test', ['exports', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
  ...
  describe('Acceptance | a4 - Démarrer un test |', function () {
    ...
    it('a4.1 Je peux démarrer un test depuis la liste des tests de la page d\'accueil', function (done) {
    ...
    it('a4.2 Quand je démarre un test, je suis redirigé vers la première épreuve du test', function (done) {
      var $startLink = findWithAssert('div[data-id="ref_course_id"] .start-button')[0];
...
define('pix-live/tests/acceptance/a5-voir-liste-tests-adaptatifs-test', ['exports', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
