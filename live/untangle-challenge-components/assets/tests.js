...
define('pix-live/tests/app.lint-test', [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('components/challenge-item.js', function () {
      // test passed
    });
    ...
    it('utils/answer-validators.js', function () {
      // test passed
    });
...
define('pix-live/tests/integration/components/qcm-proposals-test', ['chai', 'mocha', 'ember-mocha'], function (_chai, _mocha, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration | Component | QCM proposals', function () {
    ...
    (0, _mocha.it)('renders checkboxes and labels', function () {
      // given
      ...
      this.render(Ember.HTMLBars.template({
        "id": "eMuNQ1pi",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qcm-proposals\",null,[[\"proposals\",\"answer\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // then
      (0, _chai.expect)(this.$('label').first().text().trim()).to.equal('possibilite 1, et/ou');
      (0, _chai.expect)(this.$('label').last().text().trim()).to.equal('possibilite 2');
    });

    (0, _mocha.it)('sets the initial checkbox state according to the answer', function () {
      // given
      this.set('proposals', '- possibilite 1, et/ou\n - possibilite 2');
      ...
      // then
      var firstCheckbox = this.$('input[type=checkbox]').first();
      var secondCheckbox = this.$('input[type=checkbox]').last();
      (0, _chai.expect)(firstCheckbox.prop('checked')).to.be.false;
      (0, _chai.expect)(secondCheckbox.prop('checked')).to.be.true;
    });

    (0, _mocha.it)('should send an action when a checkbox value changes', function () {
      // given
      var didReceiveAction = false;
      var actionAnswerValue = null;
      this.set('proposals', '- possibilite 1, et/ou\n - possibilite 2');
      this.set('answer', { value: '' });
      this.set('externalAction', function (answerValue) {
        didReceiveAction = true;
        actionAnswerValue = answerValue;
      });
      this.render(Ember.HTMLBars.template({
        "id": "SDOwHswL",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qcm-proposals\",null,[[\"proposals\",\"answer\",\"answerChanged\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]],[25,\"action\",[[19,0,[]],[19,0,[\"externalAction\"]]],null]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // when
      var checkbox = this.$('input[type=checkbox]').last();
      checkbox.prop('checked', true);
      checkbox.change();
      // then
      (0, _chai.expect)(checkbox.prop('checked')).to.be.true;
      (0, _chai.expect)(didReceiveAction).to.be.true;
      (0, _chai.expect)(actionAnswerValue).to.equal('2');
    });
  });
});
...
define('pix-live/tests/integration/components/qcu-proposals-test', ['chai', 'mocha', 'ember-mocha'], function (_chai, _mocha, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration | Component | QCU proposals', function () {
    ...
    (0, _mocha.it)('renders radio buttons and labels', function () {
      // given
      ...
      this.render(Ember.HTMLBars.template({
        "id": "lSL/e6+j",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qcu-proposals\",null,[[\"proposals\",\"answer\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // then
      (0, _chai.expect)(this.$('.proposal-text')).to.have.lengthOf(3);
      (0, _chai.expect)(this.$('input[type=radio]')).to.have.lengthOf(3);
    });

    (0, _mocha.it)('sets the initial radio state according to the answer', function () {
      // given
      this.set('proposals', '- prop 1\n- prop 2\n- prop 3');
      this.set('answer', { value: '2' });
      // when
      ...
      // then
      (0, _chai.expect)(this.$('input[type=radio]').eq(0).prop('checked')).to.be.false;
      (0, _chai.expect)(this.$('input[type=radio]').eq(1).prop('checked')).to.be.true;
      (0, _chai.expect)(this.$('input[type=radio]').eq(2).prop('checked')).to.be.false;
    });

    (0, _mocha.it)('sends an action when a radio value changes', function () {
      // given
      var didReceiveAction = false;
      var actionAnswerValue = null;
      this.set('proposals', '- prop 1\n- prop 2\n- prop 3');
      ...
      this.render(Ember.HTMLBars.template({
        "id": "hMZ92EMr",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qcu-proposals\",null,[[\"proposals\",\"answer\",\"answerChanged\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]],[25,\"action\",[[19,0,[]],[19,0,[\"externalAction\"]]],null]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // when
      var radioButton = this.$('input[type=radio]').eq(1);
      radioButton.prop('checked', true);
      radioButton.change();
      // then
      (0, _chai.expect)(radioButton.prop('checked')).to.be.true;
      (0, _chai.expect)(didReceiveAction).to.be.true;
      (0, _chai.expect)(actionAnswerValue).to.equal('2');
    });
  });
  ...
  (0, _mocha.describe)('Integration | Component | QROC proposal', function () {
    ...
    (0, _mocha.describe)('Component behavior when user fill input of challenge:', function () {
      ...
      (0, _mocha.it)('should display a value when a non-empty value is providing by user', function () {
        ...
        this.render(Ember.HTMLBars.template({
          "id": "yQPgWKQH",
          "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qroc-proposal\",null,[[\"proposals\",\"answer\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]]]]],false]],\"hasEval\":false}",
          "meta": {}
        }));
        // then
    ...
    (0, _mocha.it)('should send an action when the input value changes', function () {
      // given
      var didReceiveAction = false;
      var actionAnswerValue = null;
      var proposals = '${myInput}';
      ...
      this.render(Ember.HTMLBars.template({
        "id": "Jz6Ecz0U",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qroc-proposal\",null,[[\"proposals\",\"answer\",\"answerChanged\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]],[25,\"action\",[[19,0,[]],[19,0,[\"externalAction\"]]],null]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // when
      var inputElement = this.$('.challenge-response__proposal-input');
      inputElement.val('My answer');
      inputElement.change();
      // then
      (0, _chai.expect)(inputElement.val()).to.equal('My answer');
      (0, _chai.expect)(didReceiveAction).to.be.true;
      (0, _chai.expect)(actionAnswerValue).to.equal('My answer');
    });
  });
});
  ...
  (0, _mocha.describe)('Integration | Component | qroc solution panel', function () {
    ...
    (0, _mocha.describe)('comparison when the answer is right', function () {
      ...
      (0, _mocha.it)('should diplay the answer in bold green and not the solution', function () {
        ...
        (0, _chai.expect)(answerInput.css('font-weight')).to.be.oneOf(['bold', '700']);
    ...
    (0, _mocha.describe)('comparison when the answer is false', function () {
      ...
      (0, _mocha.it)('should display the solution with an arrow and the solution in bold green', function () {
        ...
        (0, _chai.expect)(blockSolutionText.css('font-weight')).to.be.oneOf(['bold', '700']);
      });
    ...
    (0, _mocha.describe)('comparison of a qrocm-ind with a right answer, a wrong answer and one empty answer', function () {
      ...
      (0, _mocha.describe)('wrong answer display', function () {
        ...
        (0, _mocha.it)('should display one solution in bold green below the input', function () {
          ...
          (0, _chai.expect)(solutionText.css('font-weight')).to.be.oneOf(['bold', '700']);
...
define('pix-live/tests/integration/components/qrocm-proposal-test', ['chai', 'mocha', 'ember-mocha'], function (_chai, _mocha, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration | Component | QrocmProposalComponent', function () {
    ...
    (0, _mocha.it)('sets the initial inputs value according to the answer', function () {
      // given
      ...
      this.render(Ember.HTMLBars.template({
        "id": "hZBr5NAa",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qrocm-proposal\",null,[[\"proposals\",\"answer\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // then
      var firstInput = this.$('.challenge-response__proposal-input').first();
      var secondInput = this.$('.challenge-response__proposal-input').last();
      (0, _chai.expect)(firstInput.val()).to.equal('Firefox');
      (0, _chai.expect)(secondInput.val()).to.equal('LibreOffice');
    });

    (0, _mocha.it)('should send an action when one of the input value changes', function () {
      // given
      var didReceiveAction = false;
      var actionAnswerValue = null;
      var proposals = 'Two free softwares: ${software1#one} ${software2#two}';
      this.set('proposals', proposals);
      this.set('answer', { value: '' });
      this.set('externalAction', function (answerValue) {
        didReceiveAction = true;
      ...
      this.render(Ember.HTMLBars.template({
        "id": "bXgrW/YR",
        "block": "{\"symbols\":[],\"statements\":[[1,[25,\"qrocm-proposal\",null,[[\"proposals\",\"answer\",\"answerChanged\"],[[19,0,[\"proposals\"]],[19,0,[\"answer\"]],[25,\"action\",[[19,0,[]],[19,0,[\"externalAction\"]]],null]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
      // when
      var inputElement = this.$('.challenge-response__proposal-input').last();
      inputElement.val('LibreOffice');
      inputElement.change();
      // then
      (0, _chai.expect)(inputElement.val()).to.equal('LibreOffice');
      (0, _chai.expect)(didReceiveAction).to.be.true;
      (0, _chai.expect)(actionAnswerValue).to.equal('software1: \'\'\nsoftware2: LibreOffice\n');
    });
  });
});
...
define('pix-live/tests/tests.lint-test', [], function () {
  ...
  describe('ESLint | tests', function () {
    ...
    it('unit/utils/answer-validators-test.js', function () {
      // test passed
    });
...
define('pix-live/tests/unit/utils/answer-validators-test', ['chai', 'mocha', 'pix-live/utils/answer-validators'], function (_chai, _mocha, _answerValidators) {
  'use strict';
  ...
  (0, _mocha.describe)('Unit | Helpers | AnswerValidator', function () {

    (0, _mocha.it)('basic behavior for validation success', function () {
      // given
      var validator = _answerValidators.default.validatorForChallenge('QCU', 'my answer value');
      // then
      (0, _chai.expect)(validator.isValid()).to.be.true;
      (0, _chai.expect)(validator.value).to.equal('my answer value');
    });

    (0, _mocha.it)('basic behavior for validation failure', function () {
      // given
      var validator = _answerValidators.default.validatorForChallenge('QCU', null);
      // then
      (0, _chai.expect)(validator.isValid()).to.be.false;
      (0, _chai.expect)(validator.value).to.equal(null);
      (0, _chai.expect)(_typeof(validator.errorMessage)).to.equal('string');
    });

    (0, _mocha.describe)('QCU validation', function () {
      testInvalidAnswers('QCU', [null, '']);
      testValidAnswers('QCU', ['1']);
    });

    (0, _mocha.describe)('QCM validation', function () {
      testInvalidAnswers('QCM', [null, '']);
      testValidAnswers('QCM', ['1', '1,2']);
    });

    (0, _mocha.describe)('QROC validation', function () {
      testInvalidAnswers('QROC', [null, '']);
      testValidAnswers('QROC', ['i', 'Firefox', 'Steve Jobs']);
    });

    (0, _mocha.describe)('QROCM validation', function () {
  ...
  function testValidAnswers(type, answers) {
    answers.forEach(function (answer) {
      (0, _mocha.it)('validates that a \'' + printable(answer) + '\' answer is valid', function () {
        var validator = _answerValidators.default.validatorForChallenge(type, answer);
        (0, _chai.expect)(validator.isValid()).to.be.true;
      });
    });
  }
  ...
  function testInvalidAnswers(type, answers) {
    answers.forEach(function (answer) {
      (0, _mocha.it)('validates that a \'' + printable(answer) + '\' answer is invalid', function () {
        var validator = _answerValidators.default.validatorForChallenge(type, answer);
        (0, _chai.expect)(validator.isValid()).to.be.false;
        (0, _chai.expect)(_typeof(validator.errorMessage)).to.equal('string');
      });
