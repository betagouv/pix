...
define('pix-live/tests/acceptance/194-enregistrement-sur-la-plateforme-test', ['exports', 'mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _mocha, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {

  (0, _mocha.describe)('Acceptance | 194 - S\'enregistrer sur la plateforme', function () {
    ...
    (0, _mocha.it)('1.2 la page d\'accueil contient un formulaire d\'enregistrement Nom / Prénom / Email  / Mot de passe / Confirmation / CGU et un bouton "S\'enregistrer"', function () {
      (0, _chai.expect)(findWithAssert('label[for="inputFirstName"]').text()).to.contains('Prénom');
      (0, _chai.expect)(findWithAssert('#inputFirstName'));

      (0, _chai.expect)(findWithAssert('label[for="inputLastName"]').text()).to.contains('Nom');
      (0, _chai.expect)(findWithAssert('#inputLastName'));

      (0, _chai.expect)(findWithAssert('label[for="inputEmail"]').text()).to.contains('e-mail');
      (0, _chai.expect)(findWithAssert('#inputEmail'));

      (0, _chai.expect)(findWithAssert('label[for="inputPassword"]').text()).to.contains('Mot de passe');
      (0, _chai.expect)(findWithAssert('#inputPassword'));

      (0, _chai.expect)(findWithAssert('label[for="inputPasswordConfirm"]').text()).to.contains('Confirmation du mot de passe');
      (0, _chai.expect)(findWithAssert('#inputPasswordConfirm'));

      (0, _chai.expect)(findWithAssert('label[for="inputHasAcceptedCGU"]').text()).to.contains('CGU');
      (0, _chai.expect)(findWithAssert('#inputHasAcceptedCGU'));

      (0, _chai.expect)(findWithAssert('#buttonRegister').text()).to.contains('Enregistrez-vous');
    });
...
define('pix-live/tests/acceptance/194-enregistrement-sur-la-plateforme-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - acceptance/194-enregistrement-sur-la-plateforme-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('acceptance/194-enregistrement-sur-la-plateforme-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/acceptance/38-s-identifier-test', ['exports', 'mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (exports, _mocha, _chai, _pixLiveTestsHelpersStartApp, _pixLiveTestsHelpersDestroyApp) {
  ...
  _mocha.describe.skip("Acceptance | 38 - S'identifier sur la plateforme", function () {
...
define('pix-live/tests/authenticators/jwt.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - authenticators/jwt.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('authenticators/jwt.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/authorizers/custom.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - authorizers/custom.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('authorizers/custom.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/components/login-form.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/login-form.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('components/login-form.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/components/registration-form.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/registration-form.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('components/registration-form.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
/* global $, Date */
define('pix-live/tests/helpers/ember-simple-auth', ['exports', 'ember-simple-auth/authenticators/test'], function (exports, _emberSimpleAuthAuthenticatorsTest) {
...
define('pix-live/tests/integration/components/login-form-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('login-form', 'Integration: LoginFormComponent', {
    integration: true
  }, function () {
...
/* jshint expr:true */
define('pix-live/tests/integration/components/login-form-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/login-form-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/login-form-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
});
define('pix-live/tests/integration/components/registration-form-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('registration-form', 'Integration: RegistrationFormComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'registration-form', ['loc', [null, [1, 0], [1, 21]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('pix-live/tests/integration/components/registration-form-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/registration-form-test.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('integration/components/registration-form-test.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/routes/application.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/application.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('routes/application.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
...
define('pix-live/tests/services/session-account.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - services/session-account.js', function () {
    it('should pass ESLint', function () {
      if (!true) {
        var error = new chai.AssertionError('services/session-account.js should pass ESLint.\n');
        error.stack = undefined;throw error;
      }
    });
  });
  ...
  (0, _mocha.describe)('ConfigurePixApiHostInitializer', function () {
    ...
    (0, _mocha.describe)('configurePixApiHost', function () {
      ...
      (0, _mocha.it)('should detect Pix production', function () {
        ...
        // then
        (0, _chai.expect)(pixApiHost).to.equal('http://api-production.pix-app.ovh');
      });
