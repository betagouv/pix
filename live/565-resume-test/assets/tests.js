...
define('pix-live/tests/acceptance/h2-page-warning-timee-test', ['mocha', 'chai', 'pix-live/tests/helpers/application'], function (_mocha, _chai, _application) {
  ...
  (0, _mocha.describe)('Acceptance | h2 - Warning prochaine page timée  | ', function () {
    ...
    _mocha.describe.skip('h2-Affichage de la page warning pour 2 epreuves timées du même types (suite au bug US-424)', function () {
  ...
  (0, _mocha.describe)('Integration | Component | competence level progress bar', function () {
    ...
    (0, _mocha.describe)('resume assessment link', function () {
      ...
      (0, _mocha.it)('should display `Reprendre` if level is not defined (-1) and there is an assessment related', function () {
        ...
        this.render(Ember.HTMLBars.template({
          "id": "TPncpud+",
          "block": "{\"symbols\":[],\"statements\":[[1,[25,\"competence-level-progress-bar\",null,[[\"level\",\"assessmentId\",\"name\"],[[19,0,[\"level\"]],[19,0,[\"assessmentId\"]],[19,0,[\"name\"]]]]],false]],\"hasEval\":false}",
          "meta": {}
        }));
