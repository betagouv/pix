...
define('pix-live/mirage/data/assessments/completed-assessment', ['exports', 'pix-live/mirage/data/courses/simple-course', 'pix-live/mirage/data/answers/qcu-answer', 'pix-live/mirage/data/answers/qcu-answer-with-image', 'pix-live/mirage/data/answers/qcm-answer', 'pix-live/mirage/data/answers/qroc-answer', 'pix-live/mirage/data/answers/qrocm-answer'], function (exports, _pixLiveMirageDataCoursesSimpleCourse, _pixLiveMirageDataAnswersQcuAnswer, _pixLiveMirageDataAnswersQcuAnswerWithImage, _pixLiveMirageDataAnswersQcmAnswer, _pixLiveMirageDataAnswersQrocAnswer, _pixLiveMirageDataAnswersQrocmAnswer) {
  exports['default'] = {
    data: {
      type: 'assessments',
...
define('pix-live/mirage/routes/get-answer', ['exports', 'pix-live/mirage/data/answers/qcu-answer', 'pix-live/mirage/data/answers/qcu-answer-with-image', 'pix-live/mirage/data/answers/qcm-answer', 'pix-live/mirage/data/answers/qcm-answer-ko', 'pix-live/mirage/data/answers/qcm-answer-ok', 'pix-live/mirage/data/answers/qroc-answer', 'pix-live/mirage/data/answers/qroc-answer-ko', 'pix-live/mirage/data/answers/qroc-answer-ok', 'pix-live/mirage/data/answers/qrocm-answer'], function (exports, _pixLiveMirageDataAnswersQcuAnswer, _pixLiveMirageDataAnswersQcuAnswerWithImage, _pixLiveMirageDataAnswersQcmAnswer, _pixLiveMirageDataAnswersQcmAnswerKo, _pixLiveMirageDataAnswersQcmAnswerOk, _pixLiveMirageDataAnswersQrocAnswer, _pixLiveMirageDataAnswersQrocAnswerKo, _pixLiveMirageDataAnswersQrocAnswerOk, _pixLiveMirageDataAnswersQrocmAnswer) {
  exports['default'] = function (schema, request) {

    var answers = {
      'answer_qcm_id': _pixLiveMirageDataAnswersQcmAnswer['default'],
      'answer_qcu_with_image_id': _pixLiveMirageDataAnswersQcuAnswerWithImage['default'],
      'answer_qcu_id': _pixLiveMirageDataAnswersQcuAnswer['default'],
      'answer_qroc_id': _pixLiveMirageDataAnswersQrocAnswer['default'],
      'answer_qroc_ok_id': _pixLiveMirageDataAnswersQrocAnswerOk['default'],
      'answer_qroc_ko_id': _pixLiveMirageDataAnswersQrocAnswerKo['default'],
      'answer_qrocm_id': _pixLiveMirageDataAnswersQrocmAnswer['default'],
      'answer_qcm_ko_id': _pixLiveMirageDataAnswersQcmAnswerKo['default'],
      'answer_qcm_ok_id': _pixLiveMirageDataAnswersQcmAnswerOk['default']
    };

    var answer = answers[request.params.id];
  ...
  exports['default'] = function (schema, request) {
    ...
    switch (request.params.id) {
      ...
      case _pixLiveMirageDataChallengesQrocChallenge['default'].data.id:
        return _pixLiveMirageDataChallengesQrocChallenge['default'];
...
define('pix-live/mirage/routes/post-answers', ['exports', 'pix-live/mirage/data/challenges/qcm-challenge', 'pix-live/mirage/data/challenges/qcu-challenge', 'pix-live/mirage/data/challenges/qroc-challenge', 'pix-live/mirage/data/challenges/qrocm-challenge', 'pix-live/mirage/data/answers/qcm-answer', 'pix-live/mirage/data/answers/qcu-answer', 'pix-live/mirage/data/answers/qroc-answer', 'pix-live/mirage/data/answers/qrocm-answer'], function (exports, _pixLiveMirageDataChallengesQcmChallenge, _pixLiveMirageDataChallengesQcuChallenge, _pixLiveMirageDataChallengesQrocChallenge, _pixLiveMirageDataChallengesQrocmChallenge, _pixLiveMirageDataAnswersQcmAnswer, _pixLiveMirageDataAnswersQcuAnswer, _pixLiveMirageDataAnswersQrocAnswer, _pixLiveMirageDataAnswersQrocmAnswer) {
  exports['default'] = function (schema, request) {
