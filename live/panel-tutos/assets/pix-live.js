  ...
  exports.default = Ember.Component.extend(_emberKeyboard.EKMixin, _focusableComponent.default, {
    ...
    helpData: {
      ...
      '@tri4': {
        ...
        more: [{ title: 'Trier des infos - Filtres (Excel)', link: 'https://www.youtube.com/watch?v=uLG_6vq2CN0&index=9&list=PLXvDAEJkEN9TTc1IAEIuyxQoE7OY4wqs7', type: 'video', duration: '3 mn', from: 'chaine : Les Tutos de Claire' }, { title: 'Trier ses données', link: 'https://openclassrooms.com/courses/analysez-des-donnees-avec-excel/trier-ses-donnees', type: 'page', duration: '8 mn', from: 'openclassroom' }] },
      '@calcul4': {
      ...
      '@form_intero4': {
        clue: 'Il faut choisir tous les fichiers que l’on peut ouvrir avec un tableur (Calc, Excel,  etc.). Aidez-vous des extensions.',
      ...
      '@remplir5': {
        clue: 'Le fichier contient plusieurs feuilles. Comment y accéder ? Cherchez les onglets au bas de la feuille affichée (plus rarement en haut) et cliquez dessus.',
        tutorials: [{ title: 'Gestion des lignes et des colonnes', link: 'http://www.courstechinfo.be/Excel/LignesEtColonnes.html', type: 'page', duration: '2 mn', from: 'courstechinfo' }, { title: 'Ajout', link: ' suppression : lignes', type: 'page', duration: '3 mn', from: 'christianwtd.free' }],
        more: [{ title: 'Manipuler les lignes', link: 'Les colonnes et les cellules dans Excel', type: 'video', duration: '7 mn', from: 'chaine : jp baillaud' }] },
      '@recopie4': {
      ...
      '@extraire5': {
        clue: 'Avez-vous réalisé tous les filtres nécessaires ?',
        tutorials: [{ title: 'Trier et filtrer les données d\'un tableau', link: 'https://www.youtube.com/watch?v=PNCMzJ6M1ik', type: 'video', duration: '7 mn', from: 'Chaine : Tutech' }],
        more: [{ title: 'Les filtres de données', link: 'https://www.formuleexcel.com/tutoriel-les-filtres-de-donnees-sur-excel/', type: 'page', duration: '10 mn', from: 'formuleexcel.com' }]
      },
      '@recopie5': {
      ...
      '@extraire6': {
        clue: 'Votre tableau calculait-il bien les moyennes ? Les affichait-il bien avec un seul chiffre après la virgule ? Avez-vous actualisé le tableau après avoir fait les modifications ?',
        tutorials: [{ title: 'Créer un tableau croisé dynamique pour analyser des données de feuille de calcul', link: 'https://support.office.com/fr-fr/article/Cr%C3%A9er-un-tableau-crois%C3%A9-dynamique-pour-analyser-des-donn%C3%A9es-de-feuille-de-calcul-a9a84538-bfe9-40a9-a8e9-f99134456576', type: 'page', duration: '7 mn', from: 'support office' }, { title: 'Tutoriel 91 : créer un tableau croisé dynamique', link: 'https://www.youtube.com/watch?v=3ysyXwFxRqI', type: 'video', duration: '2 mn', from: 'chaine : TutorielGeo - GIS Center' }],
        more: [{ title: 'Créer un tableau croisé dynamique', link: 'https://www.youtube.com/watch?v=OlypTkG3M7U', type: 'video', duration: '12 mn', from: 'chaine : Lydia Provin' }, { title: 'Créer un tableau croisé dynamique', link: 'https://www.youtube.com/watch?v=IwzmI-2Vyvs', type: 'video', duration: '6 mn', from: 'chaine : Tutech' }, { title: 'Apprendre à créer un tableau croisé dynamique avec Libre Office Calc', link: 'http://malick-nseck.developpez.com/tutoriels/apprendre-a-creer-tableau-croise-dynamique-avec-libre-office-calc/', type: 'page', duration: '0 mn', from: 'développez' }] }
    },
    help: Ember.computed('challenge', function () {
      var data = this.get('helpData');
      var skills = this.get('challenge.skills');
      var id = false;
      if (skills && skills.length > 0 && skills[0].name) {
        id = skills[0].name;
      }
      var hasContents = id ? data[id] ? true : false : false;
      var clue = hasContents ? data[id].clue : null;
      var tutorials = hasContents ? data[id].tutorials ? data[id].tutorials : null : null;
      var more = hasContents ? data[id].more ? data[id].more : null : null;
      return {
...
define('pix-live/routes/certification-course', ['exports', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _authenticatedRouteMixin) {
  'use strict';
...
define("pix-live/templates/components/tutorial-panel", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "omIL+pHj", "block": "{\"symbols\":[\"value\",\"key\",\"tutorial\",\"key\"],\"statements\":[[6,\"div\"],[7],[0,\"\\n\"],[4,\"if\",[[20,[\"contents\"]]],null,{\"statements\":[[0,\"  \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;align-items:center;width:100%;justify-content:space-between;margin-top:20px;\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"style\",\"width:180px;border-top:solid 1px #000000;height:1px\"],[7],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"style\",\"font-size:25px\"],[7],[0,\"Pour réussir la prochaine fois\"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"style\",\"width:180px;border-top:solid 1px #000000;height:1px\"],[7],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[4,\"if\",[[20,[\"clue\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;align-items:center;margin-top:30px;margin-bottom:30px;padding:10px 0;\"],[7],[0,\"\\n      \"],[6,\"div\"],[10,\"style\",[26,[\"background-image:url(\",[18,\"rootURL\"],\"/images/comparison-window/indice.png);height:71px;flex:0 0 65px;margin-right:25px;\"]]],[7],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"style\",\"font-size:17px;\"],[7],[0,\"\\n        \"],[1,[18,\"clue\"],false],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"tutorials\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"style\",\"width:100%;\"],[7],[0,\"\\n\"],[4,\"each\",[[20,[\"tutorials\"]]],null,{\"statements\":[[0,\"      \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;justify-content:space-between;border-bottom:solid 1px #dadadb;width:100%;padding:10px 0;color:#858891\"],[7],[0,\"\\n        \"],[6,\"div\"],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"style\",\"margin-bottom:5px;\"],[7],[0,\"\\n            \"],[6,\"a\"],[10,\"href\",[26,[[19,3,[\"link\"]]]]],[9,\"style\",\"color:#3461fe;font-size:17px;\"],[9,\"target\",\"_blank\"],[7],[0,\"\\n              \"],[1,[19,3,[\"title\"]],false],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n          \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;font-size:14px;\"],[7],[0,\"\\n            \"],[6,\"div\"],[10,\"style\",[26,[\"background-image:url(\",[18,\"rootURL\"],\"/images/comparison-window/type_\",[19,3,[\"type\"]],\".png);flex: 0 0 26px;height:21px;\"]]],[7],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"style\",\"width:50px;border-right:solid 1px #858891;margin-left:10px\"],[7],[0,\"\\n              \"],[1,[19,3,[\"duration\"]],false],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"style\",\"margin-left:10px\"],[7],[0,\"\\n            par \"],[1,[19,3,[\"from\"]],false],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n      \"],[8],[0,\"\\n\"]],\"parameters\":[3,4]},null],[0,\"      \"],[6,\"div\"],[9,\"style\",\"margin-top:4px;color:#858891;\"],[7],[0,\"\\n        Ces liens ont été proposés par les utilisateurs de Pix.\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[20,[\"more\"]]],null,{\"statements\":[[0,\"    \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;align-items:center;width:100%;justify-content:space-between;margin:40px 0 30px 0;\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"style\",\"width:180px;border-top:solid 1px #000000;height:1px\"],[7],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"style\",\"font-size:25px\"],[7],[0,\"Pour en apprendre davantage\"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"style\",\"width:180px;border-top:solid 1px #000000;height:1px\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"style\",\"width:100%;margin-bottom:30px;\"],[7],[0,\"\\n\"],[4,\"each\",[[20,[\"more\"]]],null,{\"statements\":[[0,\"      \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;justify-content:space-between;border-bottom:solid 1px #dadadb;width:100%;padding:10px 0;color:#858891;\"],[7],[0,\"\\n        \"],[6,\"div\"],[7],[0,\"\\n          \"],[6,\"div\"],[9,\"style\",\"margin-bottom:5px;\"],[7],[0,\"\\n            \"],[6,\"a\"],[10,\"href\",[26,[[19,1,[\"link\"]]]]],[9,\"style\",\"color:#3461fe;font-size:17px;\"],[9,\"target\",\"_blank\"],[7],[0,\"\\n              \"],[1,[19,1,[\"title\"]],false],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n          \"],[6,\"div\"],[9,\"style\",\"display:flex;flex-direction:row;font-size:14px;\"],[7],[0,\"\\n            \"],[6,\"div\"],[10,\"style\",[26,[\"background-image:url(\",[18,\"rootURL\"],\"/images/comparison-window/type_\",[19,1,[\"type\"]],\".png);flex: 0 0 26px;height:21px;\"]]],[7],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"style\",\"width:50px;border-right:solid 1px #858891;margin-left:10px\"],[7],[0,\"\\n              \"],[1,[19,1,[\"duration\"]],false],[0,\"\\n            \"],[8],[0,\"\\n            \"],[6,\"div\"],[9,\"style\",\"margin-left:10px\"],[7],[0,\"\\n            par \"],[1,[19,1,[\"from\"]],false],[0,\"\\n            \"],[8],[0,\"\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n      \"],[8],[0,\"\\n\"]],\"parameters\":[1,2]},null],[0,\"      \"],[6,\"div\"],[9,\"style\",\"margin-top:4px;color:#858891;\"],[7],[0,\"\\n        Ces liens ont été proposés par les utilisateurs de Pix.\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[8]],\"hasEval\":false}", "meta": { "moduleName": "pix-live/templates/components/tutorial-panel.hbs" } });
});
