  ...
  exports.default = Ember.Component.extend(_emberKeyboard.EKMixin, _focusableComponent.default, {
    ...
    helpData: {
      '@calcul2': {
        ...
        tutorials: [{
          title: 'Références de cellules', link: 'https://support.office.com/fr-fr/article/Comprendre-et-utiliser-les-r%C3%A9f%C3%A9rences-de-cellule-ecb125bb-c0cb-48c1-b30f-cdb3aec052b1', type: 'page', duration: '1 mn', from: 'support Microsoft'
        }],
      ...
      '@tri4': {
        ...
        tutorials: [{ title: 'Trier et filtrer des donnée sExcel', link: 'http://www.linternaute.com/hightech/guide-high-tech/1412955-excel-trier-et-filtrer-ses-donnees/', type: 'page', duration: '2 mn', from: 'linternaute' }, { title: 'Trier et fltrer : les bases des feuilles de calcul', link: 'https://ecoledesdonnees.org/handbook/cours/trier-et-filtrer/', type: 'page', duration: '6 mn', from: 'ecoledesdonnees' }],
      ...
      '@recopie4': {
        ...
        tutorials: [{ title: 'Comment copier des formules dans Excel', link: 'https://fr.wikihow.com/copier-des-formules-dans-Excel', type: 'page', duration: '12 mn', from: 'wikihow' }, { title: '03-Comprendre la recopie de formule', link: 'https://www.youtube.com/watch?v=hlN1Xrg5OR4', type: 'video', duration: '3 mn', from: 'Sophie Formation' }],
        more: [{ title: 'Références', link: 'http://www.courstechinfo.be/Excel/References.html', type: 'page', duration: '1 mn', from: 'courstechinfo' }]
      },
      '@calcul5': {
        clue: 'Faites vous bien la différence entre « A1:A3 » et « A1;A3 » ?', tutorials: [{ title: 'Dans un tableur quelles sont les références de cellules syntaxiquement valide ?', link: 'https://www.c2i-revision.fr/complement.php?id_con=448', type: 'page', duration: '1 mn', from: 'c2i-revision' }],
      ...
      '@remplir6': {
        clue: 'Les résultats à ajouter sont sur une autre feuille. Il faut regarder sur les onglets en bas et choisir la bonne feuille.', tutorials: [{ title: 'Manipuler les lignes les colonnes et les cellules dans Excel', link: 'https://www.youtube.com/watch?v=NRzARdLMKoc', type: 'video', duration: '7 mn', from: 'chaine : jp baillaud' }]
      }
    },
