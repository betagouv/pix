...
define('pix-live/tests/app.lint-test', [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('models/assessment-progress.js', function () {
      // test passed
    });
...
define('pix-live/tests/tests.lint-test', [], function () {
  ...
  describe('ESLint | tests', function () {
    ...
    it('unit/models/assessment-progress-test.js', function () {
      // test passed
    });
...
define('pix-live/tests/unit/models/assessment-progress-test', ['chai', 'mocha', 'ember-mocha'], function (_chai, _mocha, _emberMocha) {
  'use strict';

  (0, _mocha.describe)('Unit | Model | assessment-progress', function () {
    (0, _emberMocha.setupModelTest)('assessment-progress', {
      needs: []
    });
    ...
    (0, _mocha.describe)('#stepPercentage', function () {
      (0, _mocha.it)('should return the number of challenges for this assessment', function () {
        // given
        var currentStep = 1;
        var maxStep = 3;
        var progress = this.subject({ currentStep: currentStep, maxStep: maxStep });
        var expectedPercentage = currentStep / maxStep * 100;

        // when
        var percentage = progress.get('stepPercentage');

        // then
        (0, _chai.expect)(percentage).to.equal(expectedPercentage);
      });
    });
  });
});
