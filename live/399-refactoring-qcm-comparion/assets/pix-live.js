...
define('pix-live/components/qcm-solution-panel', ['exports', 'ember', 'pix-live/utils/labeled-checkboxes'], function (exports, _ember, _pixLiveUtilsLabeledCheckboxes) {
  exports['default'] = _ember['default'].Component.extend({
    answer: null,
    solution: null,
    challenge: null,
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"API_HOST":"","name":"pix-live","version":"1.4.4+f1b32297"});
}
