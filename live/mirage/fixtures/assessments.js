...
export default [
  { id: 'ref_assessment_id', 'user-id':'user_id', 'user-name': 'Jon Snow', 'user-email': 'jsnow@winterfell.got', course: 'ref_course_id', answers: ['ref_answer_qcm_id', 'ref_answer_qcu_id', 'ref_answer_qroc_id', 'ref_answer_qrocm_id'] },
/*
...
*/
  ...
  { id: 'pix_name_assessment_id', 'user-id': 'user_id', 'user-name': 'Jane Doe', 'user-email': 'jane@acme.com', course: 'pix_name_course_id', answers: ['first_challenge_answer_id', 'second_challenge_answer_id'] }
];
