...
define('pix-live/components/qcm-proposals', ['exports', 'ember', 'pix-live/utils/checked-proposals'], function (exports, _ember, _pixLiveUtilsCheckedProposals) {
  exports['default'] = _ember['default'].Component.extend({

    checkedProposals: _ember['default'].computed('proposals', 'answers', function () {
      return (0, _pixLiveUtilsCheckedProposals['default'])(this.get('proposals'), this.get('answers'));
    }),
...
define('pix-live/components/qcm-solution-panel', ['exports', 'ember', 'pix-live/utils/checked-proposals', 'pix-live/utils/value-as-array-of-boolean', 'pix-live/utils/proposals-as-array', 'pix-live/utils/lodash-custom'], function (exports, _ember, _pixLiveUtilsCheckedProposals, _pixLiveUtilsValueAsArrayOfBoolean, _pixLiveUtilsProposalsAsArray, _pixLiveUtilsLodashCustom) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    checkedProposals: _ember['default'].computed('answer', function () {
      ...
      if (_pixLiveUtilsLodashCustom['default'].isNonEmptyString(answer)) {
        ...
        checkboxes = (0, _pixLiveUtilsCheckedProposals['default'])(proposalsArray, answerArray);
      }
      return checkboxes;
    })
  });
});
define('pix-live/components/qcu-proposals', ['exports', 'ember', 'pix-live/utils/checked-proposals'], function (exports, _ember, _pixLiveUtilsCheckedProposals) {
...
define('pix-live/components/qcu-solution-panel', ['exports', 'ember', 'pix-live/utils/checked-proposals', 'pix-live/utils/value-as-array-of-boolean', 'pix-live/utils/proposals-as-array', 'pix-live/utils/lodash-custom'], function (exports, _ember, _pixLiveUtilsCheckedProposals, _pixLiveUtilsValueAsArrayOfBoolean, _pixLiveUtilsProposalsAsArray, _pixLiveUtilsLodashCustom) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    labeledRadios: _ember['default'].computed('answer', function () {
      ...
      if (_pixLiveUtilsLodashCustom['default'].isNonEmptyString(answer)) {
        ...
        var proposalsArray = (0, _pixLiveUtilsProposalsAsArray['default'])(proposals);
        var answerArray = (0, _pixLiveUtilsValueAsArrayOfBoolean['default'])(answer);
        radiosArray = (0, _pixLiveUtilsCheckedProposals['default'])(proposalsArray, answerArray);
      }
