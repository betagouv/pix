...
describe('Acceptance | e2 - Prévisualisation  d\'un test |', function () {
  ...
  describe("Prévisualiser la première page d'un test |", function () {
    ...
    it("e2.1 L'accès à la preview d'un test se fait en accédant à l'URL /courses/:course_id/preview", function () {
    ...
    describe('On affiche', function () {
      ...
      it('e2.2 le nom du test', function () {
        expect($preview.find('.course-name').text()).to.contains("First Course");
      });

      it('e2.3 la description du test', function () {
        expect($preview.find('.course-description').text()).to.contains("Contient toutes les sortes d\'epreuves");
      });

      it('e2.4 un bouton pour démarrer la simulation du test et qui mène à la première question', function () {
  ...
  describe("Prévisualiser une épreuve dans le cadre d'un test |", function () {
    ...
    it("e2.5 L'accès à la preview d'une épreuve d'un testse fait en accédant à l'URL /courses/:course_id/preview/challenges/:challenge_id", function () {
    ...
    describe('On affiche', function () {
      ...
      it("e2.6 la consigne de l'épreuve", function () {
        expect($challenge.find('.challenge-instruction').html()).to.contain("Un QCM propose plusieurs choix");
      });

      it("e2.7 un bouton pour accéder à l'épreuve suivante", function () {
