...
describe('Acceptance | j1 - Comparer réponses et solutions pour un QCM |', function () {
  ...
  describe('j1.1 sur l\'ecran des resultats', function () {
    ...
    it('j1.1.2 le contenu de la modale n\'est pas encore affichée' , async function () {
  ...
  describe('j1.2 Accès à la modale', function () {
    ...
    it('j1.2.0 On peut accèder directement à la modale via URL et fermer la modale' , async function () {
      expect($('.comparison-window')).to.have.lengthOf(1);
    });
  ...
  describe.skip('j1.3 Contenu de la modale : résultat & instruction', function () {
  ...
  describe.skip('j1.4 Contenu de la modale : propositions', function () {
