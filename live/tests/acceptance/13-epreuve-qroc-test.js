...
describe("Acceptance | 13 - Afficher un QROC | ", function () {
  ...
  it('13.1 It should render challenge instruction', function () {
    ...
    expect($('.challenge-instruction').text()).to.equal('Un QROC est une question ouverte ' +
      'avec un simple champ texte libre pour répondre');
  });
  ...
  it.skip('13.3 Error alert box should be displayed if user validate without typing any text', function () {
