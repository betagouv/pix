...
define('pix-live/tests/acceptance/a1-page-accueil-test', ['mocha', 'chai', 'pix-live/tests/helpers/start-app', 'pix-live/tests/helpers/destroy-app'], function (_mocha, _chai, _startApp, _destroyApp) {
  ...
  (0, _mocha.describe)('Acceptance | a1 - La page d\'accueil', function () {
    ...
    (0, _mocha.describe)('contient une section avec un call to action pour enregistrer de nouveaux partenaires', function () {

      (0, _mocha.it)('a1.16 avec un titre', function () {
      ...
      (0, _mocha.it)('a1.17 avec une description', function () {
      ...
      (0, _mocha.it)('a1.17 avec un lien vers la page d’engagement', function () {
