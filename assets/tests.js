  ...
  (0, _mocha.describe)('Acceptance: 4-DemarrerEpreuve', function () {
    ...
    */
    ...
    (0, _mocha.it)('4.1 affiche la zone de consigne', function () {
      (0, _chai.expect)(find('.zone-de-consigne').text()).to.contains(challenge.attrs.instruction);
    });

    (0, _mocha.it)('4.2 affiche la zone de réponse', function () {
      (0, _chai.expect)(find('.zone-de-reponse').text()).to.contains('Réponse');
    });

    (0, _mocha.it)('4.3 rappelle l\'intitulé du test', function () {
      (0, _chai.expect)(find('.intitule-de-test').text()).to.contains(assessment.course.attrs.name);
    });

    (0, _mocha.it)("4.4 affiche l'état d'avancement du test", function () {
      (0, _chai.expect)(find('.avancement-du-test').text()).to.contains('Épreuve 1 / ' + assessment.challenges.models.length);
    });
...
define('pix-live/tests/routes/assessment-show.jshint', ['exports'], function (exports) {
  'use strict';

  describe('JSHint | routes/assessment-show.js', function () {
    it('should pass jshint', function () {
      if (!true) {
        var error = new chai.AssertionError('routes/assessment-show.js should pass jshint.');
        error.stack = undefined;throw error;
      }
    });
  });
