...
define('pix-live/models/course', ['exports', 'ember-data/model', 'ember-data/attr'], function (exports, _emberDataModel, _emberDataAttr) {
  exports['default'] = _emberDataModel['default'].extend({
    name: (0, _emberDataAttr['default'])('string'),
    description: (0, _emberDataAttr['default'])('string'),
...
define('pix-live/serializers/course', ['exports', 'ember-airtable/serializer'], function (exports, _emberAirtableSerializer) {
...
define("pix-live/templates/home", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["attribute", "src", ["concat", [["get", "course.imageUrl", ["loc", [null, [13, 56], [13, 71]]]]]]]],
          locals: [],
          templates: []
        };
      })();
      ...
      return {
        ...
        statements: [["attribute", "data-id", ["concat", [["get", "course.id", ["loc", [null, [11, 59], [11, 68]]]]]]], ["block", "if", [["get", "course.imageUrl", ["loc", [null, [12, 24], [12, 39]]]]], [], 0, 1, ["loc", [null, [12, 18], [16, 25]]]], ["content", "course.name", ["loc", [null, [18, 42], [18, 59]]]], ["content", "course.description", ["loc", [null, [21, 20], [21, 44]]]], ["block", "link-to", ["assessment-create", ["get", "course.id", ["loc", [null, [25, 51], [25, 60]]]]], ["class", "btn btn-primary btn-small"], 2, null, ["loc", [null, [25, 20], [27, 32]]]]],
        locals: ["course"],
        templates: [child0, child1, child2]
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model", ["loc", [null, [10, 18], [10, 23]]]]], [], 0, null, ["loc", [null, [10, 10], [30, 19]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("pix-live/app")["default"].create({"name":"pix-live","version":"0.0.0+a1443c30"});
}
